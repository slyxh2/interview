...
describe('Scheduling UMD bundle', () => {
  ...
  it('should define the same scheduling API', () => {
    ...
    const secretAPI = require('react/src/forks/ReactSharedInternalsClient.umd').default;
    validateForwardedAPIs(api, [umdAPIDev, umdAPIProd, umdAPIProfiling, secretAPI.Scheduler]);
  });
});